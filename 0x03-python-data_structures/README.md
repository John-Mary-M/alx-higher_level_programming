In this project I learn about Python Data Structures. Lists and Tuples.

0_print_list_integer.py: function that prints all integers of a list.
...
1_element_at.py: function that retrieves an element from a list like in C.
